...
// @tag.name Users
// @tag.description User management endpoints. All endpoints require admin role authentication.

// @tag.name Permissions
// @tag.description Permission and role management endpoints. All endpoints require session cookie authentication.

// @tag.name Settings
// @tag.description Application settings management endpoints. All endpoints require admin role authentication.

// @tag.name PrayerTimes
// @tag.description Prayer times retrieval endpoints. Fetches prayer times from external sources.
