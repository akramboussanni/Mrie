...
type AppConfig struct {
	...
	JwtExpirations map[string]int64 `env:"JWT_EXPIRATIONS" default:"{\"credential\":3600,\"refresh\":129600}"` // 1h, 36h

	// Default admin user configuration
	DefaultAdminEmail    string `env:"DEFAULT_ADMIN_EMAIL" default:"admin@mrie.com"`
	DefaultAdminUsername string `env:"DEFAULT_ADMIN_USERNAME" default:"admin"`
	DefaultAdminPassword string `env:"DEFAULT_ADMIN_PASSWORD" default:"admin123"`
}
